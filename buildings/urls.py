...
urlpatterns = [
  ...
  path('communities/<int:community_id>/buildings/<int:pk>/unissign-contact-person/',
       BuildingUnassignContactPersonAPIView.as_view(), name='building-unissign-contact-person'),
]
